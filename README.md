...
I build at the intersection of AI and finance. Chilean engineer turned entrepreneur, now finishing my MBA at Penn State.

**Founder & CEO of [AutomatifAI](https://automatifai.com)** — a profitable B2B SaaS company building AI-powered chatbots and automation systems for businesses across Latin America and beyond.

**IB & PE Intern at Kaiross** — supporting M&A transactions in the middle market.

**MBA Candidate at Penn State Smeal College of Business** (May 2026) with a Master's in Engineering Sciences from Universidad de los Andes.

<p align="left"> <img src="https://komarev.com/ghpvc/?username=j0selarenas&label=Profile%20views&color=0e75b6&style=flat" alt="j0selarenas" /> </p>

---

### What I'm Working On

- 🏗️ Scaling AutomatifAI's multi-agent AI systems and WhatsApp/Telegram integrations
- 💼 M&A deal execution and financial modeling at Kaiross
- 🎓 Wrapping up MBA coursework — heavy focus on applied AI in finance
- 🧪 Building tools that combine LLMs with financial analysis (multi-agent frameworks, automated pitch books, simulation analyzers)
...
**AI/ML:** OpenAI API, Anthropic API, LangChain, Scikit-learn, Pandas, NumPy, Hugging Face

**Cloud & Infra:** AWS, Azure, GCP, Node.js, Docker

**Data:** MySQL, PostgreSQL, Power BI, Tableau

**Other:** React, Linux, MATLAB, Git, SCRUM
